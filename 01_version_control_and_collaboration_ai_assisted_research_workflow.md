# A reproducible AI-assisted research workflow

---

- Last Update: 2026-08-07
- Source: [01_version_control_and_collaboration_ai_assisted_research_workflow.md](/learning-modules/intro-ds-module/01_version_control_and_collaboration_ai_assisted_research_workflow.md)
...
- inspect and verify AI-generated changes before accepting them;
- record enough evidence to explain an accepted change;
- create coherent commits that connect code, documentation, and verification;
- identify confidentiality, citation, authorship, and research-integrity risks; and
...
- [Why use Git and GitHub?](01_version_control_and_collaboration_motivation.md)
- [Create your maize yield repository](01_version_control_and_collaboration_repository_setup.md)
- [A collaborative Git workflow](01_version_control_and_collaboration_application.md)
...
An AI interaction does not automatically deserve a commit. A commit should represent one coherent, accepted project outcome.
...
- [The Turing Way: Overview of Reproducible Research](https://book.the-turing-way.org/reproducible-research/overview.html)
  ...
  documentation.
- [Documentation tools for data management](04_data_management_tools.md) explains how Markdown,

...
- Source: [04_data_management_concepts.md](/learning-modules/intro-ds-module/04_data_management_concepts.md)
...
The [Motivation page](04_data_management_motivation.md) explains why reproducible computation is not sufficient when data are misunderstood. This page provides the vocabulary and decisions needed to complete [the maize data-management application](04_data_management_application.md).
...
Identifiers are usually safer for matching because labels can differ in:
...
Metadata are data about data. Useful source metadata may describe:

- concepts and definitions;
- collection or estimation methods;
...
Continue with [Manage the maize-yield data](04_data_management_application.md). During the exercise, return to this page whenever a task requires a definition or scientific decision.
